"""
Here is an implementation of SOAP-Sania (SOAP without sqrt in the second momentum). 
Based on SOAP: https://github.com/nikhilvyas/SOAP
"""
...
class SOAPSania(torch.optim.Optimizer):
    """
    Implements SOAP-Sania algorithm (SOAP without sqrt in the second momentum).
    ...
    Example of usage:
        optim = SOAPSania(lr = 3e-3, betas=(.95, .95), weight_decay=.01, precondition_frequency=10)
    """
