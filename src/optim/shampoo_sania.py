...
class DistributedShampooSania(torch.optim.Optimizer):
    """
    Shampoo-Sania: Shampoo with 1/4 power instead of 1/2 power for preconditioner inversion.
    ...
    def __init__(
        ...
        super(DistributedShampooSania, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(DistributedShampooSania, self).__setstate__(state)
    ...
    def _update_distributed_shampoo(
        ...
        for i, param in enumerate(params):
            ...
            if grad.dim() >= 2:
                ...
                preconditioned_grad = grad / (pc1.pow(0.25) + eps)
...
class AdEMAMixDistributedShampooSania(torch.optim.Optimizer):
    """
    AdEMAMix optimizer with Distributed Shampoo-Sania preconditioning (1/4 power).
    ...
    def _update_adamemix_distributed_shampoo(
        ...
        for i, param in enumerate(params):
            ...
            # Combine AdEMAMix update with Shampoo-Sania preconditioning
            combined_grad = (
